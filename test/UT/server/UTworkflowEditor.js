...
wf.__set__("readChildWorkflow", (label, node)=>{return cwf});
...
describe("Unit test for workflowEditor", function(){
  beforeEach(function(){
  ...
  describe("#createNode", function(){
    ...
    it("should add node[3]", async function(){
      ...
      expect(cwf.nodes[3].type).to.eql("task");
  ...
  describe.skip("#delValue", async function(){
    ...
    it("", async function(){
      await testee(label, node, prop, value);
      expectNotChanged(cwf, saved, []);
      expectNotChanged(cwf.nodes[0], saved.nodes[0], []);
      expectNotChanged(cwf.nodes[1], saved.nodes[1], []);
      expectNotChanged(cwf.nodes[2], saved.nodes[2], []);
  ...
  describe("#addLink", function(){
    const testee = wf.__get__("addLink");
    it("should add link from nodes[2] to nodes[1]", function(){
      testee(label, 2, 1, false);

      expect(cwf.nodes[1].previous).to.have.lengthOf(3);
      expect(cwf.nodes[2].next).to.have.lengthOf(2);
      expectNotChanged(cwf, saved, []);
      expectNotChanged(cwf.nodes[0], saved.nodes[0], []);
      expectNotChanged(cwf.nodes[1], saved.nodes[1], ["previous"]);
      expectNotChanged(cwf.nodes[2], saved.nodes[2], ["next"]);
    });
    it("should add else link from nodes[2] to nodes[0]", function(){
      testee(label, 2, 0, true);

      expect(cwf.nodes[0].previous).to.have.lengthOf(2);
      expect(cwf.nodes[2].else).to.have.lengthOf(2);
      expectNotChanged(cwf, saved, []);
      expectNotChanged(cwf.nodes[0], saved.nodes[0], ["previous"]);
      expectNotChanged(cwf.nodes[1], saved.nodes[1], []);
      expectNotChanged(cwf.nodes[2], saved.nodes[2], ["else"]);
    });
  });
  describe("#removeLink", function(){
    const testee = wf.__get__("removeLink");
    it("should remove link from nodes[2] to nodes[0]", function(){
      testee(label, 2, 0, false);

      expect(cwf.nodes[2].next).to.have.lengthOf(0);
      expect(cwf.nodes[0].previous).to.have.lengthOf(0);
    ...
    it("shold remove link from nodes[2] to nodes[1]", function(){
      testee(label, 2, 1, true);
      expect(cwf.nodes[2].else).to.have.lengthOf(0);
      expect(cwf.nodes[1].previous).to.have.lengthOf(1);
  ...
  describe("#removeAllLink", function(){
    ...
    it("should remove all link on nodes[1]", function(){
      ...
      expect(cwf.nodes[0].next).to.have.lengthOf(0);
      expect(cwf.nodes[1].next).to.have.lengthOf(0);
    ...
    it("should remove all link on nodes[2]", function(){
      testee(label, 2);
      ...
      expectNotChanged(cwf.nodes[0], saved.nodes[0], ["previous"]);
      expectNotChanged(cwf.nodes[1], saved.nodes[1], ["previous"]);
      expectNotChanged(cwf.nodes[2], saved.nodes[2], ["next","else"]);
    });
  });
