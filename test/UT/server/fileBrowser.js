...
describe("file Browser UT", function(){
  const input = [
    "foo",
    "bar",
    "baz",
  ...
  describe("#getContents", function(){
    it("should get all files and directories", async function(){
    ...
    it("should get files, directories and SND files", async function(){
    ...
    it("should get matched files and directories", async function(){
    ...
    it("should get matched files", async function(){
    ...
    it("should get matched directories", async function(){
  ...
  describe("#getSNDs", function(){
    it("should return glob patterns", function(){
      const expected = [
  ...
  describe("#bundleSNDFiles", function(){
    it("should return files and SND", function(){
      const expected=[
        {"path": testDirRoot, "name": "*_baz",     "type": "snd", "islink": false},
